  ...
  <section class="bg-gray-100 p-4 h-max">
    ...
    <figure class="relative mt-4 w-full rounded-md overflow-hidden h-90">
        ...
        <div class="flex flex-col text-white p-4 w-full">
          ...
          <div class="mt-1 flex flex-row items-center justify-between">
            <div class="flex flex-row gap-2.5">
              <p class="text-base text-slate-300 font-sans">{{plantStore.plant.prototype.type}} <span>
                </span>
              </p>
              <div class="flex flex-row gap-1.5 items-center">
                <div class="w-2 h-2 rounded-full bg-green-500"></div>
                <span class="font-medium text-sm font-sans text-green-500">{{wellnessStates[plantStore.plant.prototype.wellnessStateId]}}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div  v-if="isEnterprise" class="flex flex-row gap-5  ">
        ...
        <span class="text-slate-900 font-medium">{{plantStore.plant.prototype.areaCoverage}} km</span>
     </div>
      ...
      <div class="mt-4 flex flex-col gap-3">
        <div class="flex flex-row items-center justify-between">
          ...
          <div class="flex flex-row items-center gap-2">
            <div class="w-2 h-2 rounded-full bg-green-500"></div>
            <span class="text-slate-900 font-medium">{{plantStore.plant.prototype.waterThreshold}} %</span>
          </div>
        </div>
        <div class="flex flex-row items-center justify-between">
          ...
          <div class="flex flex-row items-center gap-2">
            <div class="w-2 h-2 rounded-full bg-green-500"></div>
            <span class="text-slate-900 font-medium">{{plantStore.plant.prototype.lightThreshold}}%</span>
          </div>
        </div>
        <div class="flex flex-row items-center justify-between">
          ...
          <div class="flex flex-row items-center gap-2">
            <div class="w-2 h-2 rounded-full bg-green-500"></div>
            <span class="text-slate-900 font-medium">{{plantStore.plant.prototype.temperatureThreshold}}°C</span>
          </div>
        </div>
      </div>
    </div>
    <div class="mt-3 flex flex-col px-4 py-4 bg-white rounded-lg">
      ...
      <div class="mt-4 flex flex-col gap-2">
        <div class="flex flex-row items-center justify-between">
          ...
          <span class="text-slate-900 font-medium">{{plantStore.plant.prototype.createdAt}}</span>
        </div>
        <div class="flex flex-row items-center justify-between">
          <p class="text-sm text-slate-500">Last Updated:</p>
          <span class="text-slate-900 font-medium">{{plantStore.plant.prototype.updatedAt}}</span>
        </div>
      </div>
    </div>
  </section>
