<template>
  <section class="relative p-4 w-full bg-gray-100 h-full flex flex-col">
    <div class="flex flex-col">
      ...
      <p class="mt-4 text-slate-500 font-medium">N° sensors: <span class="text-slate-900">{{ devices.length }}</span></p>
    </div>
    <button
    ...
    <div class="h-full flex-1 pb-4">
      <ul class="mt-4 flex flex-col gap-3 overflow-y-auto min-h-full max-h-0">
...
import { devices } from '../../utils/mocks/devices';
import { DEVICE_STATE } from '../../utils/types/devices';
</script>
